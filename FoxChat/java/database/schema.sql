...
(
command_id serial,
command_word varchar(60) NOT NULL,
command_message varchar(260),
...
-------------------DEPARTMENTS INSERTS
INSERT INTO departments (department_name, department_keyword, message) VALUES ('Pathway', 'pathway', 'For help with pathway you can ask me things such as... "I need help with interviews" or "Please help with my resume!". To search for a job, just type "Job Search"');
...
INSERT INTO topics (topic_name, department_id, message) VALUES ('SQL', 2, 'The Structured Query Language is a declarative language, which means that it''s a language where the developer defines what they want from the computer and not the step by step definition of what the computer should do, like in JavaScript or other imperative languages.');
INSERT INTO topics (topic_name, department_id, message) VALUES ('SQL Joins', 2, 'JOINs are clauses used to combine rows from two or more tables, based on a related column between them.');
INSERT INTO topics (topic_name, department_id, message) VALUES ('Protocol', 2, 'the protocol determines how your browser should communicate with a web browser. The two most common protocols are below, click them to learn more.');
INSERT INTO topics (topic_name, department_id, message) VALUES ('Help', 2, 'Need help with Pathway? You can ask me for help with your LinkedIn, resume, or interviews. Need help with curriculum? You can ask me about Arrays, Maps, Data Types, or SQL. For help locating job listings type "Job Search" or to start over type "/clear".');
INSERT INTO topics (topic_name, department_id, message) VALUES ('OOP', 2, 'Object Oriented Programming is about organizing your problem-solving into objects. An object is an in-memory data structure that combines state and behavior into a usable and useful abstraction. It has three key principles:'); --16
...
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('Inner Join', 13, 'The INNER JOIN selects all rows from both participating tables as long as there is a match between the columns.');
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('Left Join', 13, 'The LEFT JOIN selects all matching rows between two tables in addition to any rows from table 1 that do not match table 2');
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('Right Join', 13, 'The RIGHT JOIN selects all matching rows between two tables in addition to any rows from table 2 that do not match table 1');
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('Full Outer Join', 13, 'The FULL OUTER JOIN returns all rows between two tables(matching or not).');
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('HTTP', 14, 'Hyper Text Transfer Protocol is an application layer protocol for transmitting hypermedia documents, such as HTML. It was designed for communication between web browsers and web servers, but it can also be used for other purposes.');
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('HTTPS', 14, 'Hyper Text Transfer Protocol Secure is the secure version of HTTP, the communication protocol is encrypted using Transport Layer Security, or, formerly, Secure Sockets Layer.');
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('Inheritance', 16, 'The act of having one class adopt the properties and methods of another class. This prevents code duplication and allows you to share code across classes while having the source code live in only one class file.');
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('Polymorphism', 16, 'The idea that something can be assigned a different meaning or usage based on its context. This specifically allows variables and objects to take on more than one form.');
INSERT INTO sub_topics (sub_topic_name, topic_id, message) VALUES ('Encapsulation', 16, 'Refers to the bundling of data with the methods that operate on that data, or the restricting of direct access to some of an objects components');
...
INSERT INTO keywords (word) VALUES ('sql'); --20
INSERT INTO keywords (word) VALUES ('join'); --21
INSERT INTO keywords (word) VALUES ('joins'); --22
INSERT INTO keywords (word) VALUES ('protocol'); --23
INSERT INTO keywords (word) VALUES ('protocols'); --24
INSERT INTO keywords (word) VALUES ('oop'); --25
INSERT INTO keywords (word) VALUES ('encapsulation'); --26
INSERT INTO keywords (word) VALUES ('inheritance'); --27
INSERT INTO keywords (word) VALUES ('polymorphism'); --28
INSERT INTO keywords (word) VALUES ('object-oriented-programming'); --29
INSERT INTO keywords (word) VALUES ('principles'); --30
...
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (12, 20);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (13, 20);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (13, 21);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (13, 22);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (14, 23);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (14, 24);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (16, 25);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (16, 26);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (16, 27);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (16, 28);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (16, 29);
INSERT INTO keywords_topics (topic_id, keyword_id) VALUES (16, 30);
...
INSERT INTO links (link_body, link_name) VALUES ('https://www.geeksforgeeks.org/sql-join-set-1-inner-left-right-and-full-joins/', 'Geeks for Geeks: SQL Joins');
INSERT INTO links (link_body, link_name) VALUES ('https://www.w3schools.com/sql/sql_intro.asp', 'W3schools: SQL');
INSERT INTO links (link_body, link_name) VALUES ('https://book.techelevator.com/content/introduction-to-objects-ool.html#what-is-an-object', 'TE Book: Objects'); --16
INSERT INTO links (link_body, link_name) VALUES ('https://book.techelevator.com/content/polymorphism-ool.html#polymorphism-and-inheritance', 'TE Book: Polymorphism and Inheritance'); --17
...
INSERT INTO links_topics (link_id, topic_id) VALUES (13, 11);
INSERT INTO links_topics (link_id, topic_id) VALUES (14, 13);
INSERT INTO links_topics (link_id, topic_id) VALUES (15, 12);
INSERT INTO links_topics (link_id, topic_id) VALUES (16, 16);
INSERT INTO links_topics (link_id, topic_id) VALUES (17, 16);



----------temporary count data for charts
UPDATE topics SET search_count = 16 WHERE id = 1;
UPDATE topics SET search_count = 7 WHERE id = 2;
UPDATE topics SET search_count = 11 WHERE id = 3;
UPDATE topics SET search_count = 27 WHERE id = 4;
UPDATE topics SET search_count = 20 WHERE id = 5;
UPDATE topics SET search_count = 4 WHERE id = 6;
UPDATE topics SET search_count = 6 WHERE id = 7;
UPDATE topics SET search_count = 19 WHERE id = 8;
UPDATE topics SET search_count = 12 WHERE id = 9;
UPDATE topics SET search_count = 29 WHERE id = 10;
UPDATE topics SET search_count = 30 WHERE id = 11;
UPDATE topics SET search_count = 41 WHERE id = 12;
UPDATE topics SET search_count = 28 WHERE id = 13;
UPDATE topics SET search_count = 22 WHERE id = 14;
UPDATE topics SET search_count = 40 WHERE id = 15;
