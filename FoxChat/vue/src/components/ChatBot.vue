<template>
        ...
        <div>
            <div id='open-bubble'>
                <!-- <button id="awayBubble" v-on:click="toggleChat()" v-show='this.newUser'>
                    <div class='center-in-div'><p>Try our Demo!</p></div>
                </button> -->
                <div id='open' v-on:click="toggleChat()" v-if='!this.showChat'>
                    <div class='center-in-div'><p><font-awesome-icon icon="comments" /></p></div>
                </div>
            </div>
        <div class="chatbot" v-if='this.showChat'>
            <div class='chat-header'>
                ...
                <div id='close' v-on:click="toggleChat()">
                    <div id='close-x'><p><font-awesome-icon icon="times" /></p></div>
                </div>
            </div>
            <div id='chatbox' v-chat-scroll="{smooth: true}">
                <div 
